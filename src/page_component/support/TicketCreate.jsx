function TicketCreate() {
    return (
      ...
      <div className="row p-5 mt-5 mb-5">
        ...
        {/* Repeat the .col-4 divs for additional content */}

        <div className="col-4 p-5 mt-2 ">
          <h4>
          <i className="fa-regular fa-user " aria-hidden="true"></i> Your TreadView Account
          </h4>
        ...
        <div className="col-4 p-5 mt-2 ">
          <h4>
          <i className="fa-brands fa-contao" aria-hidden="true"></i> Coin
          </h4>
